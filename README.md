# Rubab The Perfect Men's Shop — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-rubab-mens-shop/
- **Repo:** `shreekantha3/sindagi-rubab-mens-shop` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-rubab-mens-shop/'` for GitHub Pages project-site hosting.
